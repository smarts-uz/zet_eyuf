    ...
    <div id="content" class="content-footer p-3">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                $coors = Az::$app->market->wares->coordinatesTarget(53);
                $coors1 = Az::$app->market->wares->coordinates(53);
                $orderAdress = $coors1['ordersAdress'];
                $wareAdress = $coors1['waresAdress'];
               // vd($wareAdress);
                        ...
                        [
                            'attributes' => [
                                ...
                                'jsonb_6' => [
                                    ...
                                    'widgetClass' => \zetsoft\widgets\places\ZGoogleZoirNavigationWidgetg::className(),
                                    'options' => [
                                        'config' => [
                                            'data' => [3,16],
