...
use zetsoft\dbitem\chat\ZReviewItem;
...
<div class="container-fluid mt-3">
    ...
    echo $this->require( '/webhtm/shop/user/product-common/block/yandexTab.php',);
    ?>
    <div class="row">
        <div class="col-md-12">
            <div class="card-title">
                <? $this->pjaxBegin(); ?>
                <?
                echo $this->require( '/webhtm/shop/user/product-common/block/tab_product.php', [
