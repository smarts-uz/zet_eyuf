...
JS;
            ...
            <div class="col-md-2">
                ...
                <?
                echo $this->require( '/render/phone/ZJSSipWidget/local31-sher/cleanVideoX1.php');
                ?>
            </div>
...
<script>
        ...
        /*CallBtn bosilganda buttonlarni disable qiladigan user information oladigan funksiya - Sherzod  */
    
        var tableBtnCall = document.getElementsByClassName('ovr-button');


        for (var i = 0; i < tableBtnCall.length; i++){
            tableBtnCall[i].addEventListener('click', getUserInfo);
        }
