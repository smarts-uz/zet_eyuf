...
<div class="pl-1 m-5">
    ...
    'title' => [
                    'contact_info' => [
                        ...
                        'label' => Az::l('Kontakt'),
                        'value' => function (CoreAdress $model, $key, $index, DataColumn $dataColumn) {
                            $order = ShopOrder::findOne(['core_adress_id' => $model->id]);
                            $return = '';
                            if ($order !== null)
                                $return = $order->contact_info;

                        return ZVarDumper::beauty($return);
                        }
                    ],
