...
$reviewId = $this->httpGet('review_id');
...
if ($this->modelSave($model)) {
    ...
    if ($type == 'company') {
        return $this->urlRedirect(['/shop/user/market-single/reviews', 'id' => $market_id]);
    } else {
        return $this->urlRedirect(['/shop/user/product-single/review', 'id' => $market_id]);
    }
}
