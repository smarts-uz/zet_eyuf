...
-->
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-12" id="getCartOrders">
                <?
                $this->pjaxBegin();
                echo ZButtonWidget::widget([
                    'config' => [
                ...
                echo $this->require( '/webhtm/shop/client/checkout/blocks/Shahzod.php', ['items' => $items, 'model' => $model]);
                $this->pjaxBegin();
                ?>
            </div>
