                ...
                <div class="container-fluid d-flex">
                    <div class="col-lg-3 col-md-3 col-sm-12 my-2">
                        ...
                        $companyId = $this->userIdentity()->user_company_id;
                           if (empty($companyId))$companyId=4;

                        $info = Az::$app->market->order->getInfoOrder($companyId);
                        $infos = (array)$info;
                        $statuses = [];
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <div class="row my-1 mb-1">
                            <div class="col-md-12">
                                <div class="row">
                                    <?
                                    $items = Az::$app->market->sellerStatistic->sellerInfo($companyId);
                                    $arr = Az::$app->market->userStatistic->getStatsValue();
                                    $urls = Az::$app->market->sellerStatistic->getStatsUrls();
                                    ...
                                    foreach ($items as $key => $value) {
                                        ...
                                        echo ZMarketAdminCardWidget::widget([
                                            'config' => [
                                                'percent' => $value,
                                                'title' => $arr[$key],
                                                'bg-color' => '#' . Az::$app->market->order->random_color(),
                                                'info' => 'Подробно',
                                                'icon' => $icons[$key],
                                                'infoUrl' => $urls[$key],
                                                'class' => 'text-white',
