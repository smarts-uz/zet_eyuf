...
<div class="container-fluid mt-2">
    <div class="row">
        <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 media-category">
            <?
            echo zetsoft\widgets\market\ZMenuWidgetJ::widget([
                'config' => [
                    'open' => true,
                    'mode' => 'shop'
                ],
        ...
        <div class="col-xl-9 col-lg-8">
            <div class="row">
                <div class="col-md-12 p-gfh">
                    <?php
                       echo $this->require( '/webhtm/shop/user/main/block/swiper.php');
                    ?>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12 p-0">
        <div class="row">
              ...
              <?
                echo $this->require('/webhtm/shop/user/main/block/swiperNumberOne.php');
              ?>
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <?
                       require Root . '/webhtm/shop/user/main/block/swiperNumberTwo.php';
            ...
            <div class="col-12">
                ...
                <?
                    echo $this->require('/webhtm/shop/user/main/block/swiperNumberThree.php');
    ...
    <div class="col-md-12 ">
        ...
        --><?/*
         echo $this->require( '/webhtm/shop/user/main/block/swiperNumberFour.php');
