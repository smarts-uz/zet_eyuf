...
<div class="container">
    <div class="my-div2">
        <div class="d-inline-blok my-div">
            ...
            <a href="#" class="btn-floating btn-info" data-action="click-trigger">
            ...
            <div class="vd_mega-menu-content width-xs-3 width-sm-4 width-md-5 width-lg-4 right-xs left-sm" data-action="click-target" style="display: none;">
                <div class="child-menu">
                    ...
                    <div class="content-list content-image">
                        <div data-rel="scroll" class="mCustomScrollbar _mCS_2" style="overflow: hidden;"><div class="mCustomScrollBox mCS-light" id="mCSB_2" style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;"><div class="mCSB_container" style="position: relative; top: 0px;">
                                    <ul class="list-wrapper pd-lr-10" id="scroll">
                                        <li>
                                            <div class="menu-icon"><img alt="example image" src="https://picsum.photos/200"></div>
                                ...
                                <div class="mCSB_scrollTools" style="position: absolute; display: block; opacity: 0;"><div class="mCSB_draggerContainer"><div class="mCSB_dragger" style="position: absolute; top: 0px; height: 314px;" oncontextmenu="return false;"><div class="mCSB_dragger_bar" style="position: relative; line-height: 314px;"></div></div><div class="mCSB_draggerRail"></div></div></div></div></div>
...
<script>
    ...
    $('[data-action^="click-trigger"]').click(function (event) {
        e.preventDefault();
