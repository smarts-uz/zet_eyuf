                    ...
                    <div class="vd_panel-header">
                        <div class="logo">
                            <a href="index.php"><img alt="logo"
                                                     src="/publish/inputs/user-inputs/demo_files/logo.png"></a>
                        </div>
                        <!-- logo -->
                                                                        ...
                                                                        <li>
                                                                            <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">
                                                                                <div class="menu-icon"><img
                                                                                            alt="example image"
                                                                                            src="./demo_files/avatar.jpg">
                                                                                </div>
                                                                            </a>
                                                                            <div class="menu-text"> Gabriella Montagna
                                                                                <div class="menu-info">
                                                                                    <div class="menu-date">San Diego
                                                                                    </div>
                                                                                    <div class="menu-action">
                                    <span class="menu-action-icon vd_green vd_bd-green" data-original-title="Approve"
                                          data-toggle="tooltip" data-placement="bottom">
                                        ...
                                        <i class="fa fa-times"></i>
                                                                        ...
                                                                        <li>
                                                                            <a href="#">
                                                                                <div class="menu-icon"><img
                                                                                            alt="example image"
                                                                                            src="./demo_files/avatar-4.jpg">
                                                                                </div>
                                                                            </a>
                                                                            <div class="menu-text"> Rikudou Sennin
                                                                                <div class="menu-info">
                                                                                    <div class="menu-date">Las Vegas
                                                                                    </div>
                                                                                    <div class="menu-action">
                                    <span class="menu-action-icon vd_green vd_bd-green" data-original-title="Approve"
                                          data-toggle="tooltip" data-placement="bottom">
                                        ...
                                        <i class="fa fa-times"></i>
                                                                        ...
                                                                        <li>
                                                                            <a href="#">
                                                                                <div class="menu-icon"><img
                                                                                            alt="example image"
                                                                                            src="/publish/inputs/user-inputs/demo_files/avatar-5.jpg">
                                                                                </div>
                                                                            </a>
                                                                            <div class="menu-text"> Kim Kardiosun
                                                                                <div class="menu-info">
                                                                                    <div class="menu-date">New York
                                                                                    </div>
                                                                                    <div class="menu-action">
                                    <span class="menu-action-icon vd_green vd_bd-green" data-original-title="Approve"
                                          data-toggle="tooltip" data-placement="bottom">
                                        ...
                                        <i class="fa fa-times"></i>
                                                                        ...
                                                                        <li>
                                                                            <a href="#">
                                                                                <div class="menu-icon"><img
                                                                                            alt="example image"
                                                                                            src="./demo_files/avatar-7.jpg">
                                                                                </div>
                                                                            </a>
                                                                            <div class="menu-text"> Celline Dior
                                                                                <div class="menu-info">
                                                                                    <div class="menu-date">Los Angeles
                                                                                    </div>
                                                                                    <div class="menu-action">
                                    <span class="menu-action-icon vd_green vd_bd-green" data-original-title="Approve"
                                          data-toggle="tooltip" data-placement="bottom">
                                                                    ...
                                                                    <div class="mCSB_draggerContainer">
                                                                        <div class="mCSB_dragger"
                                                                            ...
                                                                            <div class="mCSB_dragger_bar"
                                                                                 style="position: relative; line-height: 209px;"></div>
                                                                        </div>
                                            ...
                                            <div class="vd_mega-menu-content width-xs-3 width-sm-4 width-md-5 width-lg-4 right-xs left-sm"
                                                ...
                                                <div class="child-menu">
                                                    <div class="title">
                                                        Messages
                                                        <div class="vd_panel-menu">
                     <span data-original-title="Message Setting" data-toggle="tooltip" data-placement="bottom"
                           class="menu">
                        <i class="fa fa-cog"></i>
                    </span>
                                                        </div>
                                                                ...
                                                                <div class="mCSB_container mCS_no_scrollbar"
                                                                    ...
                                                                    <ul class="list-wrapper pd-lr-10">
                                                                        <li>
                                                                            <div class="menu-icon"><img
                                                                                        alt="example image"
                                                                                        src="./demo_files/avatar.jpg"></div>
                                                                            <div class="menu-text"> Do you play or
                                                                                follow any sports?
                                                                                <div class="menu-info">
                                                                                    <span class="menu-date">12 Minutes Ago </span>
                                                                                    <span class="menu-action">
                                        <span class="menu-action-icon" data-original-title="Mark as Unread"
                                              data-toggle="tooltip" data-placement="bottom">
                                            <i class="fa fa-eye"></i>
                                        </span>
                                    </span>
                                                                        ...
                                                                        <li class="warning">
                                                                            ...
                                                                            <div class="menu-text"> Good job mate !
                                                                                <div class="menu-info">
                                                                                    ...
                                                                                    <span class="menu-action">
                                        <span class="menu-action-icon" data-original-title="Mark as Read"
                                              data-toggle="tooltip" data-placement="bottom">
                                            <i class="fa fa-eye-slash"></i>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <div class="menu-text"> Just calm down babe,
                                        ...
                                        <span class="menu-action-icon" data-original-title="Mark as Unread"
                                            ...
                                            <i class="fa fa-eye"></i>
                                                                        ...
                                                                        <li>
                                                                            <div class="menu-icon"><img
                                                                                        alt="example image"
                                                                                        src="./demo_files/avatar-5.jpg">
                                                                            </div>
                                                                            <div class="menu-text"> That's the way.. I
                                                                                like it :D
                                                                                <div class="menu-info">
                                        ...
                                        <span class="menu-action-icon" data-original-title="Mark as Unread"
                                            ...
                                            <i class="fa fa-eye"></i>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <div class="menu-text"> Hello, please call
                                                                                my number..
                                                                                <div class="menu-info">
                                        ...
                                        <span class="menu-action-icon" data-original-title="Mark as Unread"
                                            ...
                                            <i class="fa fa-eye"></i>
                                                                        ...
                                                                        <li>
                                                                            ...
                                                                            <div class="menu-text"> Don't go anywhere, i
                                                                                will be coming soon
                                                                                <div class="menu-info">
                                        ...
                                        <span class="menu-action-icon" data-original-title="Mark as Unread"
                                            ...
                                            <i class="fa fa-eye"></i>
                                                        ...
                                                        <div class="closing text-center" style="">
                                                            <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">See
                                                                All Notifications <i
                                                                        class="fa fa-angle-double-right"></i></a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="vd_mega-menu-content  width-xs-3 width-sm-4  center-xs-3 left-sm"
                                                ...
                                                <div class="child-menu">
                                                    <div class="title">
                                                        Notifications
                                                        <div class="vd_panel-menu">
                     <span data-original-title="Notification Setting" data-toggle="tooltip" data-placement="bottom"
                           class="menu">
                        <i class="fa fa-cog"></i>
                    </span>
                                                                    ...
                                                                    <ul class="list-wrapper pd-lr-10">
                                                                        <li>
                                                                            <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">
                                                                                ...
                                                                                <div class="menu-text"> Someone has give
                                                                                    you a surprise
                                                                                    <div class="menu-info"><span
                                                                                                class="menu-date">12 Minutes Ago</span>
                                                                                    </div>
                                                                                </div>
                                                                            </a></li>
                                                                        <li>
                                                                            <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">
                                                                                ...
                                                                                <div class="menu-text"> Change your user
                                                                                    profile details
                                                                                    <div class="menu-info"><span
                                                                                                class="menu-date">1 Hour 20 Minutes Ago</span>
                                                                                    </div>
                                                                                </div>
                                                                            </a></li>
                                                                        <li>
                                                                            <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">
                                                                                ...
                                                                                <div class="menu-text"> Your setting is
                                                                                    updated
                                                                                    <div class="menu-info"><span
                                                                                                class="menu-date">12 Days Ago</span>
                                                                                    </div>
                                                                                </div>
                                                                            </a></li>
                                                                        <li>
                                                                            <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">
                                                                                ...
                                                                                <div class="menu-text"> Added new
                                                                                    article
                                                                                    <div class="menu-info"><span
                                                                                                class="menu-date">19 Days Ago</span>
                                                                                    </div>
                                                                                </div>
                                                                            </a></li>
                                                                        <li>
                                                                            <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">
                                                                                ...
                                                                                <div class="menu-text"> Change Profile
                                                                                    Pic
                                                                                    <div class="menu-info"><span
                                                                                                class="menu-date">20 Days Ago</span>
                                                                                    </div>
                                                                                </div>
                                                                            </a></li>
                                                                        <li>
                                        ...
                                        <li id="top-menu-profile" class="profile mega-li">
                                            <a href="#"
                                               class="mega-link" data-action="click-trigger">
            <span class="mega-image">
                <img src="./demo_files/avatar.jpg" alt="example image">
            </span>
                                                ...
                                                <div class="child-menu">
                                                    <div class="content-list content-menu">
                                                        <ul class="list-wrapper pd-lr-10">
                                                            <li>
                                                                <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">
                                                                    <div class="menu-icon"><i class=" fa fa-user"></i>
                                                                    </div>
...
"></i></div>
                                                            ...
                                                            <li>
                                                                <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">
                                                                    <div class="menu-icon"><i class="  fa fa-key"></i>
                                                                    </div>
                                        ...
                                        <li id="top-menu-settings" class="one-big-icon hidden-xs hidden-sm mega-li"
                                            ...
                                            <a href="#"
                                               class="mega-link" data-action="toggle-navbar-right">
                    ...
                    <div class="menu-container">
                        <div class="vd_mega-menu-wrapper">
                            <div class="vd_mega-menu"
                                 data-intro="&lt;strong&gt;Tabs Menu&lt;/strong&gt;&lt;br/&gt;Can be placed for dropdown menu, tabs, or user profile. Responsive for medium and small size navigation."
                                 data-step="3">
                                <ul class="mega-ul">
                                    <li id="home" class="one-icon mega-li">
                                        <a class="mega-link  vd_bg-blue" href="javascript:void(0);"
                                           data-action="click-trigger">
            <span class="mega-icon">
                     ...
                     <span data-original-title="Find Server" data-toggle="tooltip" data-placement="bottom" class="menu">
                        ...
                        <i class="fa fa-cog"></i>
                                                ...
                                                <div class="content-grid column-md-3 column-sm-2 column-xs-1 height-xs-auto height-sm-4">
                                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_4"
                                                         style="overflow: hidden;">
                                                        <div class="mCustomScrollBox mCS-light" id="mCSB_4"
                                                             style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;">
                                                            <div class="mCSB_container mCS_no_scrollbar"
                                                                 style="position: relative; top: 0px;">
                                                                <ul class="list-wrapper">
                                                                    <li><a>
                                                                            ...
                                                                            <div class="menu-text"> Venmond.com
                                                                                <div class="menu-info">
                                                                                    ...
                                                                                    <span class="menu-action">
                                        <span class="menu-action-icon vd_green vd_bd-green"
                                              data-original-title="Reboot Server" data-toggle="tooltip"
                                              data-placement="bottom">
                                            <i class="fa fa-refresh"></i>
                                        </span>
                                        <span class="menu-action-icon vd_red vd_bd-red"
                                              data-original-title="Stop Server" data-toggle="tooltip"
                                              data-placement="bottom">
                                        ...
                                        <span class="menu-action-icon vd_red vd_bd-red"
                                            ...
                                            <i class="fa fa-stop"></i>
                                                    ...
                                                    <div class="closing text-center" style="">
                                                        <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">See
                                                            All Requests <i class="fa fa-angle-double-right"></i></a>
                                                    </div>
                                                </div>
                                            </div> <!-- child-menu -->
                                        </div>   <!-- vd_mega-menu-content -->
                                    ...
                                    <li id="tabs-menu-tasks" class="one-icon mega-li">
                                        <a class="mega-link  vd_bg-green" href="javascript:void(0);"
                                           data-action="click-trigger">
            <span class="mega-icon">
                                        ...
                                        <div class="vd_mega-menu-content width-xs-3 width-sm-4 width-md-5 right-xs"
                                            ...
                                            <div class="child-menu">
                                                <div class="title">
                                                    ...
                                                    <div class="vd_panel-menu">
                     <span data-original-title="Task Setting" data-toggle="tooltip" data-placement="bottom"
                           class="menu">
                        <i class="fa fa-cog"></i>
                    </span>
                                                    </div>
                                                ...
                                                <div class="content-list content-image">
                                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_5"
                                                         style="overflow: hidden;">
                                                        <div class="mCustomScrollBox mCS-light" id="mCSB_5"
                                                             style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;">
                                                            <div class="mCSB_container mCS_no_scrollbar"
                                                                 style="position: relative; top: 0px;">
                                                                <ul class="list-wrapper pd-lr-10">
                                                                    ...
                                                                    <li>
                                                                        <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">
                                                                            ...
                                                                            <div class="menu-text"> Finish coding jquery
                                                                                plugin
                                                                                <div class="menu-info">
                                                                                    <div class="progress progress-sm">
                                                                                        <div style="width:20%"
                                                                    ...
                                                                    <li><a>
                                                                            ...
                                                                            <div class="menu-text"> Client: Zoe Project
                                                                                <div class="menu-info">
                                                                                    ...
                                                                                    <span class="menu-action">
                                        <span class="menu-action-icon" data-original-title="Call" data-toggle="tooltip"
                                              data-placement="bottom">
                                            <i class="fa fa-phone"></i>
                                                                    ...
                                                                    <li>
                                                                        <a href="http://www.venmond.com/demo/vendroid/pages-user-profile.php#">
                                                                            <div class="menu-icon"><i
                                                                                        class=" fa fa-magic"></i></div>
                                                                            <div class="menu-text"> Final error check on
                                                                                new templates
                                                                                <div class="menu-info">
                                                                                    <div class="progress progress-sm">
                                                                                        <div style="width:95%"
                                        ...
                                        <span class="menu-action-icon" data-original-title="Call" data-toggle="tooltip"
                                            ...
                                            <i class="fa fa-phone"></i>
                                                    ...
                                                    <div class="closing text-center" style="">
                                                        <a href="#">See
                                                            All Tasks <i class="fa fa-angle-double-right"></i></a>
                                                    </div>
                                                </div>
                                            </div> <!-- child-menu -->
                                        </div>   <!-- vd_mega-menu-content -->
                                    ...
                                    <li id="test-2" class="one-icon mega-li">
                                        <a class="mega-link vd_bg-yellow" href="javascript:void(0);"
                                           data-action="click-trigger">
            <span class="mega-icon">
                <i class="fa fa-pencil"></i>
                                ...
                                <span class="menu-icon">
                                    ...
                                    <li id="test" class="one-icon mega-li">
                                        <a class="mega-link vd_bg-red" href="javascript:void(0);"
                                           data-action="click-trigger">
            <span class="mega-icon">
                <i class="fa fa-plus"></i>
            </span>
                                        </a>
                                        <div class="vd_mega-menu-content  width-xs-2  center-xs-2"
                                             data-action="click-target" style="display: none;">
                                            <div class="child-menu">
                                                <div class="content-list content-menu">
                                                    <ul class="list-wrapper pd-lr-10">
                                                        <li>
                                                            <a href="#">
                                                                <span class="menu-icon"><i
                                                                        ...
                                                                        class="menu-text">Write Article</span> </a></li>
                                                        <li>
                                                            <a href="#">
                                                                <span class="menu-icon"><i
                                                                            class=" fa fa-trophy"></i></span> <span
                                                                        class="menu-text">Write News</span> </a></li>
                                                        <li>
                                                            <a href="#">
                                                                <span class="menu-icon"><i
                                                                            class=" fa fa-flask"></i></span> <span
                        ...
                        <ul>
                                    ...
                                    <ul class="clearfix">
                                        <li>
                                            ...
                                            <div class="child-menu" data-action="click-target" style="display: none;">
                                                <ul class="clearfix">
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-large-menu-tab.php">
                                                            <span class="menu-text">Large Menu Tab</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-large-tabs-tab.php">
                                                            <span class="menu-text">Large Tabs Tab</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-large-profile-tab.php">
                                                            <span class="menu-text">Large Profile Tab</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-large-no-tab.php">
                                                            <span class="menu-text">Large No Tab</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-large-chat-content.php">
                                                            <span class="menu-text">Large Chat Content</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-large-email.php">
                                                            <span class="menu-text">Large Email</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-medium-menu-tab.php">
                                                            <span class="menu-text">Medium Menu Tab </span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-medium-tabs-tab.php">
                                                            <span class="menu-text">Medium Tabs Tab</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-medium-profile-tab.php">
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-medium-no-tab.php">
                                                            <span class="menu-text">Medium No Tab </span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-small-menu-tab.php">
                                                            <span class="menu-text">Small Menu Tab</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-small-tabs-tab.php">
                                                            <span class="menu-text">Small Tabs Tab</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-small-profile-tab.php">
                                                            <span class="menu-text">Small Profile Tab</span>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-side-small-no-tab.php">
                                        ...
                                        <li>
                                            ...
                                            <div class="child-menu" data-action="click-target" style="display: none;">
                                                <ul class="clearfix">
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-top-search.php">Search </a>
                                                    </li>
                                                    <li><a href="http://www.venmond.com/demo/vendroid/nav-top-menu.php">Mega
                                                            Menu </a></li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-top-clean-style.php">
                                                            Clean Style </a></li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="child-menu" data-action="click-target" style="display: none;">
                                                <ul class="clearfix">
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-bottom-widget.php">
                                                            Chat Widget </a></li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-bottom-clean-menu.php">
                                                            Clean With Menu </a></li>
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/nav-bottom-clean-center.php">
                                                            Clean Center Text </a></li>
                                                </ul>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <li>
                                ...
                                <div class="child-menu" data-action="click-target" style="display: none;">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#">
                                                <span class="menu-text">EyufInvoice</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                            ...
                            <li>
                                <a href="http://themeforest.net/item/vendroid-super-flexible-multipurpose-admin-theme/7717536?ref=Venmond">
                                    ...
                                    <span class="menu-badge"><span class="badge vd_bg-red"><i
                ...
                <div class="navbar-menu clearfix">
                    <div class="content-list content-image content-chat">
                        <ul class="list-wrapper no-bd-btm pd-lr-10">
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="./demo_files/avatar.jpg" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="./demo_files/avatar-2.jpg" alt="example image">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="./demo_files/avatar-3.jpg" alt="example image">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="./demo_files/avatar-4.jpg" alt="example image">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="./demo_files/avatar-5.jpg" alt="example image">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="./demo_files/avatar-6.jpg" alt="example image">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="./demo_files/avatar-7.jpg" alt="example image">
                                    </div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="./demo_files/avatar-8.jpg" alt="example image">
                                    </div>
                        ...
                        <div class="vd_head-section clearfix">
                            <div class="vd_panel-header">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">User Profile Pages</li>
                                </ul>
                                <div class="vd_panel-menu hidden-sm hidden-xs"
                                    ...
                                    <div data-action="fullscreen"
                                         ...
                                         data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"><i
                                                class="glyphicon glyphicon-fullscreen fas fa-expand-arrows-alt"></i>
                                    </div>
                                </div>
                ...
                10
                     ...
                     <span data-original-title="Find Server" data-toggle="tooltip" data-placement="bottom" class="menu">
                        ...
                        <i class="fa fa-cog"></i>
                                ...
                                <div class="content-grid column-md-3 column-sm-2 column-xs-1 height-xs-auto height-sm-4">
                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_7" style="overflow: hidden;">
                                        <div class="mCustomScrollBox mCS-light" id="mCSB_7"
                                             style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;">
                                            <div class="mCSB_container mCS_no_scrollbar"
                                                 style="position: relative; top: 0px;">
                                                <ul class="list-wrapper">
                                    ...
                                    <div class="closing text-center" style="">
                                        <a href="#">See All
                                            Requests <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            </div> <!-- child-menu -->
                        </div>   <!-- vd_mega-menu-content -->
                ...
                8
                     ...
                     <span data-original-title="Task Setting" data-toggle="tooltip" data-placement="bottom"
                        ...
                        <i class="fa fa-cog"></i>
                                ...
                                <div class="content-list content-image">
                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_8" style="overflow: hidden;">
                                        <div class="mCustomScrollBox mCS-light" id="mCSB_8"
                                             style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;">
                                            <div class="mCSB_container mCS_no_scrollbar"
                                                 style="position: relative; top: 0px;">
                                                <ul class="list-wrapper pd-lr-10">
                                                    <li>
                                                        <a href="#">
                                                            <div class="menu-icon vd_blue"><i class="fa fa-bolt"></i>
                                                            </div>
                                                            <div class="menu-text"> Electricity Problem
                                                                <div class="menu-info">
                                                                    <div class="progress progress-sm">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="menu-icon vd_yellow"><i class="fa fa-code"></i>
                                                            </div>
                                    ...
                                    <div class="closing text-center" style="">
                                        <a href="#">See All
                                            Tasks <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            </div> <!-- child-menu -->
                        </div>   <!-- vd_mega-menu-content -->
                    ...
                    <li class="one-big-icon mega-li mgl-10">
                        <a href="#" class="mega-link"
                           data-action="click-trigger">
                            <span class="mega-icon"><img alt="example image" src="./demo_files/avatar.jpg"></span>
                            <span class="badge vd_bg-red">10</span>
                        </a>
                            ...
                            <div class="child-menu">
                                ...
                                <div class="content-list content-image content-menu">
                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_9" style="overflow: hidden;">
                                        <div class="mCustomScrollBox mCS-light" id="mCSB_9"
                                             style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;">
                                            <div class="mCSB_container mCS_no_scrollbar"
                                                 style="position: relative; top: 0px;">
                                                <ul class="list-wrapper pd-lr-10">
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            ...
                                                            <div class="menu-text"> Just calm down babe, everything will
                                                                work out.
                                                                <div class="menu-info">
                                                                    <span class="menu-date">12 Days Ago</span>
                                                    ...
                                                    <li class="align-right"><a
                                                            ...
                                                            <div class="menu-text"> Don't go anywhere, i will be coming
                                                                soon
                                                                <div class="menu-info">
                                                                    <span class="menu-date">1 Month 2 days Ago</span>
                                                                </div>
                    ...
                    <li class="one-big-icon mega-li mgl-10">
                        <a href="#" class="mega-link"
                           data-action="click-trigger">
                            <span class="mega-icon"><img alt="example image" src="./demo_files/avatar-10.jpg"></span>
                            ...
                            <div class="child-menu">
                                ...
                                <div class="content-list content-image content-menu">
                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_10" style="overflow: hidden;">
                                        <div class="mCustomScrollBox mCS-light" id="mCSB_10"
                                             style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;">
                                            <div class="mCSB_container mCS_no_scrollbar"
                                                 style="position: relative; top: 0px;">
                                                <ul class="list-wrapper pd-lr-10">
                            ...
                            <div class="child-menu">
                                <div class="content-list  content-image">
                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_11" style="overflow: hidden;">
                                        <div class="mCustomScrollBox mCS-light" id="mCSB_11"
                                             style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;">
                                            <div class="mCSB_container mCS_no_scrollbar"
                                                 style="position: relative; top: 0px;">
                                                <ul class="list-wrapper pd-lr-10">
                                                    <li>
                                                        <a href="#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar.jpg"
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-2.jpg"
                                                                                        alt="example image"></div>
                                                            <div class="menu-text">Rodney Mc.Cardo
                                                                <div class="menu-info">
                                                                    <span class="menu-date">Designer </span>
                                                            ...
                                                            <div class="menu-badge"><span
                                                                        class="badge status vd_bg-grey">&nbsp;</span>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-3.jpg"
                                                                                        alt="example image"></div>
                                                            <div class="menu-text">Theresia Minoque
                                                                <div class="menu-info">
                                                                    <span class="menu-date">Engineering </span>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-4.jpg"
                                                                                        alt="example image"></div>
                                                            <div class="menu-text">Greg Grog
                                                                <div class="menu-info">
                                                                    <span class="menu-date">Developer </span>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-5.jpg"
                                                                                        alt="example image"></div>
                                                            <div class="menu-text">Stefanie Imburgh
                                                                <div class="menu-info">
                                                                    <span class="menu-date">Dancer</span>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-6.jpg"
                                                                                        alt="example image"></div>
                                                            <div class="menu-text">Matt Demon
                                                                <div class="menu-info">
                                                                    <span class="menu-date">Musician </span>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-7.jpg"
                                                                                        alt="example image"></div>
                                                            <div class="menu-text">Jeniffer Anastasia
                                                                <div class="menu-info">
                                                                    <span class="menu-date">Senior Developer </span>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-8.jpg"
                                                                                        alt="example image"></div>
                                                            <div class="menu-text">Daniel Dreamon
                                                                <div class="menu-info">
                                                                    <span class="menu-date">Sales Executive </span>
