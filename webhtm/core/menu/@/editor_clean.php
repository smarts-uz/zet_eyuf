...
$this->registerJsFile('https://cdn.jsdelivr.net/npm/jquery-sortable-lists@1.4.0/jquery-sortable-lists.js');
...
$createMenuJS = file_get_contents(Root.'/webhtm/core/menu/assets/jQuery-Menu-Editor-master/jquery-menu-editor_new.js');

$js_Library = strtr($createMenuJS, [
    '{titles}' => $titleJS,
    '{action}' => $actionJS,
    '{icons}' => $iconJS,
    '{json}' => $json,
