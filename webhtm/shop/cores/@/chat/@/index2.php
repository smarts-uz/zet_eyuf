                                ...
                                <div class="d-flex">
                                    <form method="POST" action="" class="d-flex input-box">
                                        ...
                                        <div class="md-form input-group mb-3 messageBlog">
                                            <input type="text"  class="form-control" placeholder="<?= $placeholder ?>" autocomplete="off" <?= $readonly;  ?> />

                                        </div>
                                    </form>

                                    <form method="POST" action="" style="width: 300px" enctype="multipart/form-data">


                                            <button class="btn btn-sm  btn-primary border-0 rounded-circle " type="button">
                                                <i class="far fa-smile ii-n"></i>
                                            </button>
                                     

                                        <button id="chat-upload-btn-2 " class="btn btn-primary rounded-circle btn-sm border-0 dropzone-button-js" type="button">
                                        ...
                                        <button class="btn btn-sm btn-ico btn-primary rounded-circle " id="send" name="submit" type="submit">
