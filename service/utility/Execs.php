...
class Execs extends ZFrame
{
    ...
    public function execTest()
    {
        ...
        $this->exec($file . ' "d:/Develop/Projects/server/php7/7_44/php.exe" D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php caller/marce-ami/run --agentId=124', true);
        $this->exec($file . ' "d:/Develop/Projects/server/php7/7_44/php.exe" D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php caller/marce-ami/run --agentId=126', true);
        $this->exec($file . ' "d:/Develop/Projects/server/php7/7_44/php.exe" D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php caller/marce-ami/run --agentId=128', true);
