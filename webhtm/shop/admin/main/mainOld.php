...
<div id="page">
    ...
    <div class="pt-2">
        <div class="container-fluid d-flex">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row pt-4">
                                ...
                                <div class="dashboard-card dashboard-card-chart">
                                    ...
                                    <div class="dashboard-card-body">
                                        <h4 class="dashboard-card-title">
                                            Ежедневные продажи</h4>
                                        <p class="dashboard-card-category">
                                            <span class="text-success"><i class="fa fa-long-arrow-up"></i> 55% </span>увеличение сегодняшних продаж.</p>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="dashboard-card dashboard-card-chart">
                                    ...
                                    <div class="dashboard-card-body">
                                        <h4 class="dashboard-card-title">
                                            Подписки по электронной почте</h4>
                                        <p class="dashboard-card-category">Результаты последней кампании</p>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="dashboard-card dashboard-card-chart">
                                    ...
                                    <div class="dashboard-card-body">
                                        <h4 class="dashboard-card-title">Выполненные задачи</h4>
                                        <p class="dashboard-card-category">
                                            Результаты последней кампании</p>
                                    </div>
                ...
                <div id="dynaContainer" class="row pl-2 w-100">
                    <?php
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#dynaContainer").children().addClass('w-100');
        });
    </script>
