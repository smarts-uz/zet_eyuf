...
use zetsoft\service\tests\parserTest;
...
use zetsoft\service\tests\Test1;
use zetsoft\service\tests\Test2;
use zetsoft\service\tests\Test4;
use zetsoft\service\tests\Test5;
...
* @property parserTest $parserTest
...
class Tests extends Component
{
    ...
    public function getParserTest()
    {
        if ($this->_parserTest === null)
            $this->_parserTest = new parserTest();
