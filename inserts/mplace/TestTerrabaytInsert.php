...
class TestTerrabaytInsert extends ZInsert
{
    ...
    public function run()
    {
        ...
        $this->model->name = 'Заказ клиента №22 |  от . Ф.И.О ';
        ...
        $this->model->id = 23;
        $this->model->sort = null;
        $this->model->name = 'Заказ клиента № от 2020-10-05 10:31:40. Ф.И.О contact name';
        ...
        $this->model->id = 24;
        $this->model->sort = null;
        $this->model->name = 'Заказ клиента № от 2020-10-31 21:42:06. Ф.И.О contact name';
        $this->model->code = '000000000000';
        $this->model->title = '';
        $this->model->tranz = null;
        $this->model->accept = null;
        ...
        $this->model->parent = null;
        $this->model->children = null;
        $this->model->contact_name = 'contact name';
        $this->model->status_universal = '';
        $this->model->contact_phone = '1241241';
        $this->model->add_contact_phone = '';
        $this->model->date = null;
        $this->model->comment_user = '';
        $this->model->responsible = null;
