...
<div class="container-fluid" style="width: 100% !important;">
    ...
    <div id="pjaxFor" class="card  chat-room">
        <div class="card-body">
                ...
                <div class="col-md-6 col-xl-8 pl-md-3 px-lg-auto px-0">
                    ...
                    <div style="width: 100%;z-index: 20 ;background-color:#7ba6d1; height: 70px !important;"
                        ...
                        if (!empty($userId)) {
                            ...
                            $userInfo =
                                "<div style='margin-top: -23px;'><img src='$url' class='avatar rounded-circle mr-2 ml-lg-3 ml-0   z-depth-1'></div>
                              <h3 class='avattar' >$currName</h3>";
                        ...
                        if (!empty($userId)):
                            ...
                            if (empty($menBloklagan)) {
                                ...
                                <button class="btn btn-danger btn-sm btn-rounded"><i class="fas fa-ban"></i>&nbsp;Блок</button>
                            </span>';
                            } else {
                                echo '<span onclick="unblock()" class="leftBtn" >
                                ...
                                <div class="messageBlog">
                                    <div class="input-group">
                                        <input name="message" style="height: 50px" id="sendInput" type="textarea"
                                               class="form-control"
                                               placeholder="<?= $placeholder ?>" autocomplete="off" name="search"
                                            <?= $readonly; ?>/>
...
<style>
    ...
    .leftBtn{
        right: 15px;position: absolute;top:8px;cursor:pointer
    }
