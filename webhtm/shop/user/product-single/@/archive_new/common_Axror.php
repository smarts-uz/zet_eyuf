...
{
    ?>
    <!--<div class="text-muted"> <p class="fp-20">Вам нужно перейти на эту страницу, выбрав определенный продукт. Пожалуйста, выберите продукт обратно на главную страницу.</p>
    <button class="btn btn-success">Главная страница</button>--> <!--.Az::l('Вам нужно перейти на эту страницу, выбрав определенный продукт. Пожалуйста, выберите продукт обратно на главную страницу.').--></div>
    <? return null;
}
...
if ($product === null)
{
    ?> '<div class="text-muted"> <p class="fp-20">В настоящее время невозможно отобразить информацию об этом продукте. Пожалуйста, вернитесь на домашнюю страницу и попробуйте выбрать продукт снова</p>
    <button class="btn btn-success">Главная страница</button><!--'.Az::l('В настоящее время невозможно отобразить информацию об этом продукте. Пожалуйста, вернитесь на домашнюю страницу и попробуйте выбрать продукт снова.').'--></div>';
    <?php return null;
}
