...
class ReactAmiFarrukh extends ZFrame
{
    #region Vars
    ...
    public $ext = '205';
    public $port = '5038';
    public $exts = ['205', '204', '206', '207', '208', '209', '211', '212', '213', '214'];
    ...
    public function init()
    {
        ...
        /*$this->sender->coreShowChannels()->then(
            function (\Clue\React\Ami\Protocol\Response $response) {
                vdd($response);
        });*/


        $this->subExts = array_slice($this->exts, $this->sub, count($this->exts));

         foreach($this->subExts as $subExt)  {
             echo ($subExt);
         }
                      ...
                      if(true) {
                          ...
                          $this->factoryCre->then(function (Client $client) {
                              ...
                              $this->action = $client->createAction('Originate', array(
                                  'Channel' => 'SIP/' . $this->subExts[$this->sub],
    ...
    public $sub = 5;
    public function enterForPerLeave() {
    ...
    public function originateMultiple($num)
    {
        $this->factoryCre->then(function (Client $client) use ($num) {
