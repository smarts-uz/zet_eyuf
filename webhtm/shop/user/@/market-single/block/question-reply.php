...
use zetsoft\models\core\CoreFaq;
use zetsoft\models\core\CoreQuestion;
...
$item = CoreQuestion::findOne($questionId);

$model = new CoreQuestion();
...
if ($this->modelSave($model)) {
  ...
  return $this->urlRedirect(['/render/market/Questions answers/question-answer','id'=>$questionId]);
