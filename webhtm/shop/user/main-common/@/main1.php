...
<div class="container-fluid m-0 p-0" style="background: url('/render/asrorz/images/Background2.png'); background-size: 100% 100%;">
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 d-none d-lg-block media-category">
                ...
                echo zetsoft\widgets\market\ZMenuWidgetShahzod::widget([
                    'config' => [
                        'open' => true,
                        'mode' => 'shop',
                        'isAll' => true,
