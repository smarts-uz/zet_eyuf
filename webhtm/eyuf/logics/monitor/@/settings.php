...
echo ZDynaWidget::widget([
    ...
    'config' => [
        ...
        'createUrl' => '{fullUrl}/create_settings.aspx',
        'updateUrl' => '{fullUrl}/update_settings.aspx?id={id}&model={modelClass}',
        'viewUrl' => '{fullUrl}/view_settings.aspx?id={id}',
    ]
]);
