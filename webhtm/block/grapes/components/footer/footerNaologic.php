...
<head>
    ...
    $this->head();
    $this->fileCss('https://fonts.googleapis.com/css?family=Rubik');
    $this->fileCss('/render/grapeAssets/footer/footerNaologic/styleNaologic.css');


    $this->fileJs('/render/grapeAssets/menus/FlexyMegaMenu/jsFlexyMegaMenu.js');
...
<footer class="naologic-footer light-blue lighten-5">
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12">
                ...
                <div class="col-md-3 col-sm-6 col-6 p-0 float-left mb-3">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a class="cyan-lighter-hover naologic-link" href="../sales/sales-performance-market-pipeline.html">Sales</a></li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a class="cyan-lighter-hover naologic-link" href="href="../project-management/project-management.html"">Project Management</a></li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a class="cyan-lighter-hover naologic-link" href="../workforce/workforce-organization-management-hr.html">Workforce</a></li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a class="cyan-lighter-hover naologic-link" href="../e-commerce/e-commerce.html"> E-Commerce</a></li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a class="cyan-lighter-hover naologic-link" href="../finance/finance-accounting-erp.html">Finance</a></li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a class="cyan-lighter-hover naologic-link" href="../business-apps/business-apps.html">Business Apps</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-6 p-0 mb-3 float-left">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a class="cyan-lighter-hover naologic-link" href="https://github.com/naologic">Open Source</a></li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a class="cyan-lighter-hover naologic-link" href="https://stackshare.io/naologic">Technology</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-6 mb-3 p-0 float-left">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a class="cyan-lighter-hover naologic-link" href="../about-naologic.html"></i>About</a></li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a class="cyan-lighter-hover naologic-link" href="https://blog.naologic.com"></i> Blog</a></li>
                    </ul>
                </div>

                <div class="col-md-3 col-sm-6 col-6 mb-3 p-0 float-left">
                    <h5 class="mb-4 brown-text font-weight-bold text-uppercase">Connect</h5>
                    <ul class="list-group">
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                            <a class="cyan-lighter-hover naologic-link" href="https://www.linkedin.com/company/naologic"><i class="fa fa-linkedin mr-1"></i> LinkedIn</a>
                        </li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                            <a class="cyan-lighter-hover naologic-link" href="https://twitter.com/naologicerp"><i class="fa fa-twitter mr-1"></i> Twitter</a>
                        </li class="list-group-item bg-transparent border-0 p-0 mb-2">
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                            <a class="cyan-lighter-hover naologic-link" href="https://www.reddit.com/r/naologic/"><i class="fa fa-reddit mr-1"></i> Reddit</a>
                        </li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                            <a class="cyan-lighter-hover naologic-link" href="https://plus.google.com/109511516185666043480" target="_blank"><i class="fa fa-google-plus mr-1"></i> Google+</a>

                        </li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                            <a class="cyan-lighter-hover naologic-link" href="https://github.com/naologic" target="_blank"><i class="fa fa-github mr-1"></i> Github</a>
                        </li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                            <a class="cyan-lighter-hover naologic-link" href="https://blog.naologic.com" target="_blank"><i class="fa fa-medium mr-1"></i> Medium</a>
                        </li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                            <a class="cyan-lighter-hover naologic-link" href="https://www.facebook.com/naologic/" target="_blank"><i class="fa fa-facebook mr-1"></i> Facebook</a>
                        </li>
                        <li class="list-group-item bg-transparent border-0 p-0 mb-2">
                            <a class="cyan-lighter-hover naologic-link" href="https://www.youtube.com/channel/UCtHmuf2oQLnksokfz8GIbKA" target="_blank"><i class="fa fa-youtube mr-1"></i> YouTube</a>
                        </li>
                    </ul>
                </div>
