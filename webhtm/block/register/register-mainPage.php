    ...
    <div class="signin-cart z-depth-1" style="display: none">
        <div class="signin-cart-header py-2">
            ...
            <div class="d-flex flex-column p-0 px-2">
                <a href="/core/user/user-auth/loginCRM.aspx" class="btn btn-block btn-primary py-2">Войти</a>
            ...
            <hr>
            <div class="d-flex flex-column p-0 px-2">
                <span class="lead my-2">Новый покупатель?</span>
                <a href="/core/user/user-auth/registerCRM.aspx" class="btn btn-block btn-success py-2">Регистрация</a>
            </div>
        </div>
