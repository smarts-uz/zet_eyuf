            ...
            <div class="zetsoft pt-2">
                <div class="container-fluid d-flex">
                    <div class="col-lg-3 col-md-3 col-sm-12 my-2">
                        <?
                        $stats = '';
                        $status_client = (new ShopOrder())->_status_client;
                        ...
                        foreach ($infos as $key => $value) {
                            ...
                            $obj->amount = $value ?? 0;
                            $obj->status = $status_client;
                            $obj->url = '/shop/admin/shop-order/index.aspx?ShopOrder[status_client]=';
                            $statuses[] = $obj;
                        }
                            ...
                            <div class="col-md-12">
                                ...
                                echo ZChartFormWidgetJaxongir::widget([
                                    ...
                                    'config' => [
                                        ...
                                        'colorname' => 'color',
                                        'value' => 'amount',
                                        'type' => ZChartFormWidgetJaxongir::type['pie'],
                                        'theme' => ZChartFormWidgetJaxongir::theme['infographic'],
                                        'actionButtons' => [
                                            'update',
                                            'delete',
                                            'view',
