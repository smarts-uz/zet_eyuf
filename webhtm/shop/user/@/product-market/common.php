...
if (empty($productProperty) && $product===null) {
...
<div class="container-fluid mt-3">
    ...
    echo $this->require( '/webhtm/shop/user/product-market/block/yandexTab.php',[
        'id' => $product_id,
        'type' => 'product'
    ]);
    ?>
        ...
        <div class="col-md-12">
            <div class="card-title">
               <!-- --><?/* $this->pjaxBegin(); */?>
                ...
                echo $this->require( '/webhtm/shop/user/product-market/block/tab_product.php', [
