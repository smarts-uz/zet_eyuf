...
$datas = ZArrayHelper::map($actions, 'name', 'data');
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                echo ZButtonWidget::widget([
                                    'config' => [
                                        ...
                                        'class' => 'btn btn-sm btn-primary btn-2',
                                        'icon' => 'far fa-copy',
                                        'title' => 'Обновить',
                                        'hasIcon' => true,
                                ...
                                <input type="text" class="form-control item-menu inputMenu" id="param" name="param"
                    ...
                    <div class="form-group formGroup">
                        <div class="input-group">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                echo "<input type=\"hidden\" id=\"text_value\" class=\"item-menu\" name=\"text\">";
                                echo ZSelect2WidgetOLD::widget([
                                    'data' => $titles,
                                    'config' => [
                                        'placeholder' => 'Текст',
                            ...
                            <i id="ico"></i>
                            <input type="text" class="inputIcon item-menu" id="icon_value" name="icon">
                        </div>
                    </div>
                ...
                <div class="ml-auto">
                    <div class="btn-group">
                        <button type="button" class="btn btn-rounded btn-outline-danger" title="Удалить меню"
                                id="delMen"><i class="far fa-trash-alt ft"></i>
                        </button>
