...
class Notoj extends ZFrame
{
   #region example
    ...
    public function fileDoc(){
        ...
        $parser = new \Notoj\File("D:\Develop\Projects\asrorz\zetsoft\cncmd\\tester\XolmatController.php");
    ...
    public function example(){
       ...
       $dirPath =   ZFileHelper::scanFolder('D:\Develop\Projects\asrorz\zetsoft\vendors\somefiles');
