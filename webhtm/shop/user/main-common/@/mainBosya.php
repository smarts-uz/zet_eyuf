...
$productsByStatusSale = Az::$app->market->product->productByStatus(null, 4, 12, null);
$productsByStatusNew = Az::$app->market->product->productByStatus(null, 3, 12, null);
...
<div class="container-fluid  m-0 p-0"
    ...
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 d-none d-lg-block media-category">
                <!--    <? /*
            ...
            <div class="col-xl-9 col-lg-8">-->
                ...
                <?
                echo $this->require( '/render/market/ZAutoWriteWidget/autowrite.php');
                ?>
