    ...
    <div id="content" class="content-footer p-3">
        ...
        <div class="row">
            <div class="col-md-12 col-12">
               ...
               vd( $coors = Az::$app->market->wares->coordinatesTarget(29));
                vd($coors1 = Az::$app->market->wares->coordinates(29));
                $orderAdress = $coors1['ordersAdress'];
                $wareAdress = $coors['waresAdress'];
                vd($orderAdress);
                        ...
                        [
                            'attributes' => [
                                ...
                                'jsonb_6' => [
                                    ...
                                    'widgetClass' => \zetsoft\widgets\places\ZGoogleZoirNavigationWidget::className(),
                                    'options' => [
                                        'config' => [
                                            'data' => [3,16],
