<link rel="stylesheet" href="/render/chates/ZFacebookChatWidget/assets/umid.css">
...
<div class="card  chat-room">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <!-- Grid column -->
            <div class="col-md-6 col-xl-3 px-0 pr-2 border-right">

                <div class="white z-depth-1 px-2 pb-0 members-panel-1 scrollbar-light-blue">
                    <ul class="list-unstyled friend-list ">
                        <li class="active grey lighten-3 p-2">
                            <a href="#" class="d-flex justify-content-between">
                                <img src="https://placekitten.com/300/300"
                                     class="avatar w-25 rounded-circle d-flex align-self-center mr-2 z-depth-1">
                        ...
                        <li class="p-2">
                            <a href="#" class="d-flex justify-content-between">
                                <img src="https://placekitten.com/300/300"
                                     class="avatar rounded-circle w-25 d-flex align-self-center mr-2 z-depth-1">
                                <div class="text-small">
            ...
            <!-- Grid column -->
            <div class="col-md-6 col-xl-6 pl-md-3 px-lg-auto px-0 pr-2 border-right">
