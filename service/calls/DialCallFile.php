...
class DialCallFile extends ZFrame
{
    ...
    public function run()
    {
            ...
            foreach ($ids as $id) {
                ...
                Az::$app->utility->execs->exec($file . ' "5 D:/Develop/Projects/server/php7/7_44/php.exe" D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php caller/call-file/call --agentId=' . $id['id'], true);
    ...
    public function start()
    {
        ...
        Az::$app->utility->execs->exec($file . ' "5 D:/Develop/Projects/server/php7/7_44/php.exe" D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php caller/call-file/run', true);
    ...
    public function runold()
    {
        ...
        $loop->addPeriodicTimer($this->time, function (\React\EventLoop\TimerInterface $timer) use ($loop) {
            ...
            foreach ($ids as $id) {
                ...
                Az::$app->utility->execs->exec($file . ' "D:/Develop/Projects/server/php7/7_44/php.exe" D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php caller/call-file/call --agentId=' . $id['id'], true);
