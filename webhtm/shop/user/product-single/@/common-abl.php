...
$product->image = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRFthAQgQPTmU9dMxiAHEfCbce9C0iFJbhmefPNk9O2BOolNSn3&usqp=CAU';
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-title">
                    <? $this->pjaxBegin(); ?>
                    <?
                    echo $this->require( '/webhtm/shop/user/product-single/block/tab_product.php', [
