...
class ClickTest extends ZFrame
{
    #region Vars
    public $client;
    public $params;
    ...
    public $test = true;
    public $SERVICE_ID = 16409;
    public $MERCHANT_ID = 11864;
    public $MERCHANT_USER_ID = '17334';
    public $SECRET_KEY = 'ZA2PTQi6b1qS';

    public $token;
    public $amount = 10000;
    public $phone_number = '998971412636';
    public $phone = '998971412636';
    public $invoice_id = '4222';
    public $card_number = '8600140224387663';
    public $expire_date = '1024';
    public $temporary = 1;
    public $sms_code = '';
    public $card_token = '';
    public $payment_id = 1121;
    public $merchant_trans_id = 17334;

    public $baseUri;
    public const baseUri = [
        'test' => 'https://docs.click.uz',
        'main' => 'https://click.uz',
    ];
...
//    }
    ...
    public function getTokenTest(){
        vdd(Az::$app->payer->click->getToken());
    }
    ...
    public function create_invoiceTest(){
        vdd(Az::$app->payer->clickTest->create_invoice());
    }
...
/*
    public function create_invoice()
    {
        ...
        $response = $client->request('POST', '/click-api-testing', [
            'headers' => [
...
//    }
    ...
    public function getTokenTest(){
        ...
        Az::$app->payer->clickTest->getToken();
