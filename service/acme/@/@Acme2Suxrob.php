...
class Acme2Suxrob extends ZFrame
{
    ...
    public $client;
    public $path_appsll = 'D:/Develop/Projects/asrorz/zetsoft/hoster/appssl/';
    ...
    public function addSSL($app_name, $domain_name)
    {
        ...
        $path_vhosts = 'D:/Develop/Projects/server/nginx/conf/vhosts/';
    ...
    public function removeSSL($domain_name)
    {
        ...
        $conf_file = str_replace('listen 8443 ssl http2;', '', $conf_file);
