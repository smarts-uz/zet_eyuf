...
$today = Az::$app->cores->date->date();
$model->configs->query = EyufScholar::find()->where(['<','edu_end', $today]);
            ...
            'value' => function ($model, $key, $index, ZKDataColumn $dataColumn) {
                ...
                return ZButtonWidget::widget([
                    'config' => [
                        ...
                        'text' => Az::l('Подробно'),
                        'url' => ZUrl::to('/eyuf/logics/monitor/doc-list-accept.aspx?id=' . $model['id']),
            ...
            'value' => function ($model, $key, $index, ZKDataColumn $dataColumn) {
                ...
                return ZButtonWidget::widget([
                    'config' => [
                        ...
                        'btnStyle' => ZButtonWidget::btnStyle['btn-outline-primary'],
                        'text' => Az::l('отчетов'),
                        'url' => ZUrl::to('/eyuf/logics/monitor/doc-list-accept-report.aspx?id=' . $model['id']),
