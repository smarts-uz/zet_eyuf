...
class Grapes extends ZFrame
{
    ...
    public function getWidgetFolders()
    {

        $folders = ZFileHelper::scanFolder(Root . '/widgets');
...
JS;
    ...
    public function getBlocksReplace($tooltips, $config, $toolbar = null)
    {
        ...
        foreach ($data as $grapItem) {
            ...
            $item = ZArrayHelper::getValue($tooltips, $grapItem->title);
    ...
    /*
     * widgets folderni topib excludes ichidagilardan tashqarilarini olib beradi
     * */
...
//end
    ...
    //start: MurodovMirbosit
    /*
     * Barcha Widgetlarni scan qilib $grapes publiclarni olib tooltipda chiqarib beradi
     *
     * */
