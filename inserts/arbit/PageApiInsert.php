...
class PageApiInsert extends ZInsert
{
    ...
    public function run()
    {
        ...
        $this->model->type = 'ajax';
        $this->model->check = 1;
        $this->model->page_api_type_id = 56;
        $this->save();
        ...
        $this->model->type = 'html';
        $this->model->check = 1;
        $this->model->page_api_type_id = 53;
        $this->save();
        ...
        $this->model->type = 'html';
        $this->model->check = 1;
        $this->model->page_api_type_id = 49;
        $this->save();
        ...
        $this->model->id = 156;
        $this->model->sort = null;
        $this->model->name = '/shop/cart/archive/add-order-user';
        ...
        $this->model->id = 255;
        $this->model->sort = null;
        $this->model->name = '/core/rest/archive/ZEditDynaAction2';
        ...
        $this->model->id = 256;
        $this->model->sort = null;
        $this->model->name = '/core/rest/archive/ZEditDynaActionBackup';
        ...
        $this->model->id = 257;
        $this->model->sort = null;
        $this->model->name = '/core/rest/archive/ZSorting2Action';
        ...
        $this->model->type = 'html';
        $this->model->check = 1;
        $this->model->page_api_type_id = 44;
        $this->save();
