...
<div id="page">
    ...
    <div id="content" class="content-footer p-3">
        ...
        <div class="row">
            ...
            <div class="alert alert-success alert-dismissible fade show d-none" role="alert" id="flash_message_id">
                <strong>AutoDial is started</strong>
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <button class="btn btn-success" onclick="autoCall()">Auto Call</button>
...
<script>
  ...
  {
    $.ajax({
        url: '\\agent\\xolmat\\indexXolmat2.aspx',
        type: 'POST',
        ajax: true,
        data: {
