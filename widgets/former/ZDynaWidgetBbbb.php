 ...
 *
 */
class ZDynaWidgetBbbb extends ZWidget
{
...
JS,
   ...
   $('.dyna-editable').on('click', function () {
       ...
       $('.jsPanel-titlebar').html('{title}' + options.title)
...
JS,
        ...
        $sessionKey = "Provider-$className-$url-$userId";
        $session = $this->sessionGet($sessionKey);
