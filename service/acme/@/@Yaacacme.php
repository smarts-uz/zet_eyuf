...
class Yaacacme
{
    public function addSSL($project_name, $domain_name) {
        //Prepare flysystem
        global $boot;
        $path = 'D:/Develop/Projects/asrorz/zetsoft/storing/acmev2/acme-challenge/';
        ...
        if ($client->isReady($order)) {
            ...
            echo $certificate;
            echo "Success!";
            //    file_put_contents('D:/Develop/Projects/server/nginx/conf/appssl/sert.zetsoft.uz/certificate.cert', $certificate->getCertificate());
            //    file_put_contents('D:/Develop/Projects/server/nginx/conf/appssl/sert.zetsoft.uz/private.key', $certificate->getPrivateKey());
        } else {
            echo "Error!";
        }
