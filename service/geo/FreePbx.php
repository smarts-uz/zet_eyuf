...
//            [
//                'PHPSESSID' => 'c2ssieq2g8ratu55i9non5cnf1',
//            ],
//            '10.10.3.60'
//        );
        $client = new Client(['base_uri' => 'http://10.10.3.60']);
        $res = $client->request('POST', '/admin/config.php?display=extensions', [
//            'cookies' => $jar,
            'form_params' => [
                'PHPSESSID' => 'c2ssieq2g8ratu55i9non5cnf1',
                  "action" => "add",
                  ...
                  "extension" => "388",
                  "name" => "388",
                  "outboundcid" => "907435678",
                  "emergency_cid" => "",
                  "devinfo_secret" => "4ff1fbdf00d095ed6075b7a578ec2b3e",
                  "langcode" => "",
                  "userman_directory" => "1",
                  "userman_assign" => "add",
                  "userman_password" => "234774141bd36cbbbd7b1fb0f02f5a5d",
                  "userman_group[]" => "1",
                  "vm" => "disabled",
                  "vmx_option_0_number" => "",
