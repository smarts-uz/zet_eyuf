            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <button class="btn btn-success">Auto Dial Start</button>
                        <button class="btn btn-danger">Auto Dial Stop</button>
                        <?
...
JS;
            ...
            <div class="col-md-2">
                ...
                <?
                echo $this->require( '/render/phone/ZSipml5Widget/clean/iSIPML5.php');
                ?>
            </div>
