...
function message($items)
{
      ...
      $result_part = '';
      $review = $review = <<<HTML
     <div class="detailBox w-100 card card-cascade container-fluid overlay pt-1 pl-1 pb-1 m-3">
            ...
            <li class="m-0 mt-2 pb-1">
                ...
                <div class="commentText d-flex justify-content-between">
                    <div class="w-100">
                        ...
                        <ul>
                            <li>Достоинства : {virtues}</li>
                            <li>Недостатки : {drawbacks}</li>
                        </ul>
                        <img class="w-100 rounded-circle" src="{comment_image}"/>
                      {text}
      ...
      foreach ($items as $item)
      {
          ...
          $button = ZButtonWidget::widget([
              ...
              'config' => [
                //  'btnRounded' => false,
                  'text' => Az::l('Reply'),
                  'url' => Zurl::to(['/shop/user/review/orgreview','id' => $item->id]),
