...
$time1 = $_GET['time1'] ?? '2020-04-28 00:00:00';
$time2 = $_GET['time2'] ?? '2020-04-29 00:00:00';
$usernumber = $_GET['number'] ?? '202';

$mainPoint = new Asterisk;
$data = $mainPoint->getDataFromUnansweredDb($usernumber);

$date1 = date( 'Y-m-d H:i:s', strtotime($time1));
$date2 = date( 'Y-m-d H:i:s', strtotime($time2));

$mainPoint = new Asterisk;

$data = $mainPoint->getUserSearchintime($usernumber , $date1, $date2);
...
<hr>
<div class="col">
    <a href="/core/tester/asterisk/main.aspx"><button class="btn btn-primary">Home</button></a> <b>User Number : <?php echo $usernumber ?></b>
    <b>From : <?= $date1 ?> - To : <?= $date2 ?></b>
</div>
<hr>
