...
if ($this->userIsGuest()) {
    $this->urlRedirect('/core/core/login.aspx');
}
    
$userId = Az::$app->App->eyuf->chat->getUserId();
                ...
                <div  class="col-md-6 col-xl-8 pl-md-3 px-lg-auto px-0">
                    <div style="width: 100%;z-index: 20 ;background-color:rgba(255,255,255,.9);border-radius: 5px;margin-bottom: 10px;"
                        ...
                        if(!empty($userId)) {
                            ...
                            $userInfo = "<div><img src='$url' class='avatar rounded-circle mr-2 ml-lg-3 ml-0 z-depth-1' style='position: absolute;margin-top: -20px;'></div><h3  style='position: relative;margin-left: 75px;margin-top: -11px'>$currName</h3>";
                    ...
                    <div>
                        ...
                        <form method="POST" class="d-flex input-box dontSee isGuest">
