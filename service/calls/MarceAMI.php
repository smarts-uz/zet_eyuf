...
require Root . '/zetsoft/consts/PAMI/EventFactoryImpl.php';
...
class MarceAMI extends ZFrame
{
    ...
    public $remoteIp;
    public $currentIp;
    public $cmdLine = '"d:/Develop/Projects/server/php7/7_44/php.exe" D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php caller/marce-ami/run --agentId=';
    #endregion
    ...
    public function runOld1()
    {
        ...
        foreach ($ids as $id) {
            ...
            /*Az::$app->utility->execs->exec($file.' 30 "d:/Develop/Projects/server/php7/7_44/php.exe" "D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php" caller/marce-ami/call --agentId='.$id['id'], true);*/


            Az::$app->utility->execs->exec($file . ' 30 "D:/Develop/Projects/server/php7/7_44/php.exe" "D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php" caller/marce-ami/call --agentId=' . '124', false);
    ...
    {
        $file = Root . '/scripts/runner/runx.exe';
        Az::$app->utility->execs->exec($file . ' " 3 d:/Develop/Projects/server/php7/7_44/php.exe" D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php caller/marce-ami/run', true);
    ...
    public function runold()
    {
        ...
        $loop->addPeriodicTimer($this->time, function (\React\EventLoop\TimerInterface $timer) use ($loop) {
            ...
            foreach ($ids as $id) {
                ...
                Az::$app->utility->execs->exec($file . ' "d:/Develop/Projects/server/php7/7_44/php.exe" D:/Develop/Projects/asrorz/zetsoft/excmd/asrorz.php caller/marce-ami/run --agentId=' . $id['id'], true);
