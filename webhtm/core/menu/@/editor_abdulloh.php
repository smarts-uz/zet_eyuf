...
<div class="pr-2 pl-4">
    <div class="row">
        ...
        <input id="text1" name="text" type="hidden">
                    ...
                    <div class="">
                        ...
                        <div class="form-group" style="margin-left:2px;" >
                            ...
                            <div class="input-group">
                                ...
                                <select style="width:39%;" name="text" id="text_vall">
                                    <option></option>
                                    <?
...
jQuery(document).ready(function () {
    ...
    var ac_val = '';
        ...
        var example3 = $('#val__vis').select2({
            allowclear: true,
            multiple: true,
            placeholder: 'Доступ разрешен для ..'
        }).trigger('change');
...
$createMenuJS = file_get_contents('D:\Develop\Projects\asrorz\zettest\publish\menus\jQuery-Menu-Editor-master\jquery-menu-editor_shoxruh.js');
