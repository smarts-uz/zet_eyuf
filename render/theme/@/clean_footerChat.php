                        ...
                        <i class="fa fa-cog"></i>
                                ...
                                <div class="content-grid column-md-3 column-sm-2 column-xs-1 height-xs-auto height-sm-4">
                                    ...
                                    <div class="closing text-center" style="">
                                        <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">See All Requests <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            </div> <!-- child-menu -->
            ...
            <span class="mega-icon">
                ...
                8
                                ...
                                <div class="content-list content-image">
                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_10" style="overflow: hidden;"><div class="mCustomScrollBox mCS-light" id="mCSB_10" style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;"><div class="mCSB_container" style="position: relative; top: 0px;">
                                                <ul class="list-wrapper pd-lr-10">
                                                    <li> <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">
                                                    ...
                                                    <li> <a>
                                                            <div class="menu-icon"><img alt="example image" src="./demo_files/avatar-3.jpg"></div>
                                    ...
                                    <div class="closing text-center" style="">
                                        <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">See All Tasks <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            </div> <!-- child-menu -->
                        </div>   <!-- vd_mega-menu-content -->
                            ...
                            <div class="child-menu">
                                ...
                                <div class="content-list content-image content-menu">
                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_11" style="overflow: hidden;"><div class="mCustomScrollBox mCS-light" id="mCSB_11" style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;"><div class="mCSB_container mCS_no_scrollbar" style="position: relative; top: 0px;">
                                                <ul class="list-wrapper pd-lr-10">
                                                    <li> <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img alt="example image" src="./demo_files/avatar.jpg"></div>
                                                    ...
                                                    <li class="align-right"> <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img alt="example image" src="./demo_files/avatar-2.jpg"></div>
                    ...
                    <li class="profile mega-li pdlr-15 bordered">
                        <a class="mega-link" href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#" data-action="click-trigger">
                                ...
                                <div class="content-list  content-image">
                                    <div data-rel="scroll" class="mCustomScrollbar _mCS_13" style="overflow: hidden;"><div class="mCustomScrollBox mCS-light" id="mCSB_13" style="position: relative; height: 100%; overflow: hidden; max-width: 100%; max-height: 400px;"><div class="mCSB_container mCS_no_scrollbar" style="position: relative; top: 0px;">
                                                <ul class="list-wrapper pd-lr-10">
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-2.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-3.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-4.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-5.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-6.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-7.jpg" alt="example image"></div>
                                                    ...
                                                    <li>
                                                        <a href="http://www.venmond.com/demo/vendroid/index-ecommerce.php#">
                                                            <div class="menu-icon"><img src="./demo_files/avatar-8.jpg" alt="example image"></div>
