...
<div id="page">
    ...
    $startRange = $this->sessionGet('supervisorRangeDatePeriodd');
    ...
    if ($period && $post !== null) {
        ...
        $this->sessionSet('supervisorRangeDatePeriodd', $period);
        $this->urlRedirect(['/supervisor/main/index-j'], true);

    }

    if ($startRange) {
        $beginDate = $this->sessionGet('supervisorRangeDatePeriodd')[0];
        $endDate = $this->sessionGet('supervisorRangeDatePeriodd')[1];
