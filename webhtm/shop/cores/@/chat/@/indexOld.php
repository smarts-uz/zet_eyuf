                ...
                <div class="col-md-6 col-xl-8 pl-md-3 px-lg-auto px-0">
                    ...
                    <div style="width: 100%;z-index: 20 ; height: 70px !important;"
                        ...
                        if (!empty($userId)) {
                            ...
                            $userInfo =
                                "<h3 class='font-bold text-dark font-md ml-4 text-uppercase' >$currName</h3>";
                        ...
                        if (!empty($userId)):
                            ...
                            if (empty($menBloklagan)) {
                                echo '<span onclick="block()" class="leftBtn">
                                    <button class="btn btn-danger btn-md btn-rounded" style=" right: 15px;position: absolute;top:8px;cursor:pointer"><i class="fas fa-ban"></i>&nbsp;Блок</button>
                                </span>';
                            } else {
                            ...
                            <? if (!empty($userId)):
                                ...
                                <div class="row">
                                    ...
                                    <div class="d-flex col-lg-10">
                                        <form method="POST" action="" class="d-flex input-box">
                                            ...
                                            <div class="md-form input-group mb-3 messageBlog">
                                                <input type="text" name="message" class="form-control" placeholder="<?= $placeholder ?>" autocomplete="off" <?= $readonly;  ?> />
                                    ...
                                    <div class="input-group-append col-lg-2">
                                        <button class="btn btn-lg btn-primary btn-rounded" type="submit" id="send" name="submit"><i class="far fa-paper-plane"></i></button>
                                    </div>
                                </div>
