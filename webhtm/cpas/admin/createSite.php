            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    if ($this->modelSave($model)) {
                        ...
                        //$topath = Root . '/render/cpanet/' . CpasOffer::findOne(CpasOfferItem::findOne($model->cpas_offer_item_id)->cpas_offer_id)->title . '/' . PlaceCountry::findOne(CpasOfferItem::findOne($model->cpas_offer_item_id)->place_country_id)->alpha2 . '/';
                        //Az::$app->office->zipArchive->unzip($path, $topath);
                        //$cpasOfferItem = CpasOfferItem::findOne($model->cpas_offer_item_id)->cpas_offer_id;
                        //$cpasOffer = CpasOffer::findOne($cpasOfferItem)->shop_catalog_id;
                        //$replace = Az::$app->office->zipArchive->replace($topath.'/landing.html', $cpasOffer);
