...
//$items = Az::$app->market->review->getReviewByProductId(442);
// vdd($items);
if (!isset($items)) {
    $val = new ReviewItem();
    $val->id = '18';
    $val->product_id = '18';
    $val->user_name = 'user';
    $val->user_image = 'https://pluspng.com/img-png/user-png-icon-male-user-icon-512.png';
    $val->text = ' Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci consectetur doloribus molestiae optio provident repellat tempore. Cumque debitis dignissimos error fugit impedit mollitia obcaecati reiciendis ullam veniam voluptatem! Officia, suscipit!';
    $val->photo = 'https://pluspng.com/img-png/user-png-icon-male-user-icon-512.png';
    $val->rating = 3;
    $val->rating_option;
    $val->experience;
    $val->recommend;
                ...
                <ul class="list-unstyled mb-0 commentList p-0">
                    <li class="m-0 mt-2 pb-1">
                        <div style="width:40px" class="commenterImage  float-left mr-2 h-100">
                            <img class="w-100 rounded-circle" src="https://www.searchpng.com/wp-content/uploads/2019/02/Deafult-Profile-Pitcher.png"/>
                        </div>
                            ...
                            <div class="w-100">
                                <div class="d-flex">
                                    ...
                                    <div class="d-block">
                                        ...
                                        <small class="font-weight-light">{time_ago}</small> </div>
                                    </div> 
                                </div>
                                
                                <ul class="list-unstyled font-weight-normal">
                                    <li class="font-weight-lighter">{virtues}</li>
                                    <li class="font-weight-lighter">{drawbacks}</li>
                                    <li class="font-weight-light">{text}</li>
    ...
    foreach ($items as $item) {
        ...
        $button = ZButtonWidget::widget([
            ...
            'config' => [
                //  'btnRounded' => false,
                'text' => Az::l('Ответить'),
                'url' => Zurl::to(['/shop/user/item-review/review-product-reply', 'id' => $item->id]),
