...
$json       = file_get_contents('http://api.ipstack.com/'.$user_ip.'?access_key=98308ea83d85971a34b29d479c192fd8');

vd($json       = json_decode($json ,true));
...
vd($url = Az::$app->maps->navigation->urlGeneratorGoogle(53));
