...
trait Localization
{
     ...
     * @return string
     */
    public static function translateWith($translator, string $key, array $parameters = [], $number = null): string
    {
     ...
     * @return string
     */
    public function translate(string $key, array $parameters = [], $number = null, $translator = null, bool $altNumbers = false): string
    {
