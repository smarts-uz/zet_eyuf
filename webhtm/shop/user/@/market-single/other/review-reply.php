...
$item = new ShopReview();
$item->user_id = 1;
$item->photo = 'https://image.shutterstock.com/image-photo/white-transparent-leaf-on-mirror-260nw-1029171697.jpg';
...
?>
    ...
    <div class="card view view-cascade overlay market-container pt-4 pr-4 pl-4 pb-1 mt-1">
        <?php $this->beginBody(); ?>
        ...
        <div class="float-right">
            ...
            echo ZButtonWidget::widget([
                ...
                'config' => [
                    'url' => '/shop/user/market-single/reviews.aspx',
                    'btnType' => 'submit',
                    'text' => Az::l('Send'),
