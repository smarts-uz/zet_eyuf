...
class ZDynaWidget extends ZWidget
{
    ...
    public $_rightBtn = [
        ...
        'export' => [
            'content' => '{jsonExcel}{exportAll}{import}',
    ...
    public function codes()
    {
        ...
        $this->_layout = [
            ...
            'importFromExcel' => ZIframePanelWidget::widget([
                ...
                'config' => [
                    ...
                    'funcName' => 'dynaImport' . $this->modelClassName,
...
JS,
        ...
        $importFromExcel = $this->_layout['importFromExcel'];
...
HTML;
        ...
        echo ZJspanelWidgetRavshan::widget([
            ...
            'config' => [
                'funcName' => 'dynaImport' . $this->modelClassName,
                'iframeSrc' => $this->prelastUrl(). "/import.aspx?modelClassName={$this->modelClassName}&spa=1",
            ]
        ]);
