    ...
    <div id="content" class="content-footer p-3">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mx-auto mt-5">
                ...
                $ware_exit_item->configs->readonly = true;
                ...
                echo ZDynaWidget::widget([
                    ...
                    'config' => [
                        ...
                        'chooseUrl' => '{fullUrl}/choose.aspx?ware_id=' . $ware_exit->ware_id . '&user_company_id=' . $ware_exit->user_company_id . '&ware_exit_id=' . $ware_exit_id,
                        'actionButtons' => [
                            'clone',
                            'delete',
                            'view'
