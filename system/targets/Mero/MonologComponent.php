...
use Monolog\Logger;
use zetsoft\system\targets\Mero\Exception\InsufficientParametersException;
use zetsoft\system\targets\Mero\Exception\InvalidHandlerException;
use zetsoft\system\targets\Mero\Exception\LoggerNotFoundException;
    ...
    public function init()
    {
        ...
        if (!isset($this->channels['main'])) {
            $this->channels['main'] = [
                'handler' => [
                    'type' => 'stream',
                    'path' => Root . '/storing/loggers/cmd/monolog/logs/monolog-new.log',
                ],
            ];
        }
