...
class AcmeCoreZoir extends ZFrame
{
    ...
    public function addSSL($app, $subdomain, $sslConf) {
        ...
        Please add these paths to your config file and u should change your domain name   
         ssl_certificate     		\"d:/Develop/Projects/asrorz/zetsoft/hoster/appssl/domain_name/ssl.crt\"; \n
         ssl_certificate_key 		\"d:/Develop/Projects/asrorz/zetsoft/hoster/appssl/domain_name/ssl.key \"; \n
        " ;
