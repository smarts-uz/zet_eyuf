...
<div class="container">
            ...
            <div class="classic-tab mt-5 px-2">
                ...
                <ul class="nav d-flex text-center row justify-content-between" id="myClassicTabShadow" role="tablist">
                    ...
                    <li class="nav-item border border-dange px-0 col-sm active">
                        <a class="nav-link  waves-light text-muted w-100 fp-17  show" id="profile-tab-classic-shadow"
                           data-toggle="tab" href="#profile-classic-shadow"
                           role="tab" aria-controls="profile-classic-shadow" aria-selected="true">ОписаниеE</a>
                    </li>
