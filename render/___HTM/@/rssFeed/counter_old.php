...
<noscript><div><img src="https://mc.yandex.ru/watch/57697924" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
...
<a href="https://www.hitwebcounter.com" target="_blank">
    <img src="https://hitwebcounter.com/counter/counter.php?page=7201166&style=0001&nbdigits=5&type=page&initCount=0" title="User Stats" Alt="webcounterwebsite"   border="0" >
</a>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-159145471-1"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-159145471-1');
</script>


 <!-- Counter From Git Hub  https://github.com/bfintal/Counter-Up -->
<!-- Counter From Git Hub  https://github.com/inorganik/CountUp.js -->

<!-- Google Аналитика
    login: zetcountertest@gmail.com
    Pass: zetcountertest123
...
-->
<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-159144009-1"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-159144009-1');
</script>
