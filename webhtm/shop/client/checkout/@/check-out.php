...
<div class="pl-1 m-5">
    <div class="row col-12">
        <div class="col-9 p-0 ">
            ...
            $obj->gender='m';
            $obj->lang='ru';
            $obj->phone='+998998154828';
            $obj->email='saloh224@gmail.com';
            $obj->website;
            $obj->photo='https://png.pngtree.com/png-vector/20190710/ourmid/pngtree-user-vector-avatar-png-image_1541962.jpg';
            $obj->status;
            $obj->lastseen;
            $obj->blocked;
            $obj->verify_code;
            ...
            $obj->oauth;
            $obj->oauth_type;
            $obj->user_company_id = null;
            $obj->place_adress_ids;
            $obj->created_at;
            $obj->modified_at;
            $obj->created_by;
            $obj->modified_by;
     ...
     $model->code=5443;
     $model->name='name';
     $model->place_country_id;
     $model->place_region_id;
     $model->street='street';
     $model->home=7;
     $model->orientation=543;
     $model->postal_code=3432;
     $model->location;
     $model->created_at;
     $model->modified_at;
     $model->created_by;
