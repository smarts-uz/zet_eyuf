...
use rmrevin\yii\fontawesome\FA;use zetsoft\dbitem\core\WebItem;
...
require Root . '/webhtm/shop/agent/manual/navbar1.php';
?>
                            ...
                            'contact_name' => [
                                [
                                    ...
                                    'value' => function ($model, $key, $index, DataColumn $dataColumn) {
                                        ...
                                        {
                                           e.preventDefault(); 
                                          document.getElementById("txtPhoneNumber").value = '308';
                                          console.log(document.getElementById("txtPhoneNumber").value);
...
JS;
                        ...
                        $all = ZButtonWidget::widget([
                            'config' => [
                                ...
                                'title' => '',
                                'grapes' => false,
                                'url' => $this->urlGetBase() . '/agent/manual/all.aspx',
            ...
            <div class="col-xl-2 col-lg-3 col-md-4">
                ...
                //$item->impi = $this->userIdentity()->number;
                //$item->password = $this->userIdentity()->number;
