...
class ProductXolmat extends ZFrame
{
...
#region test collection
    ...
    private function test1()
    {
       ...
       //  vdd($this->allProducts(549));
        ...
        //vdd($this->allProducts(550));
        //vdd($this->getAllProductsByBrand(11));
      // vdd($this->getAllProductsByCompany(null, 40));
       // vdd($this->filterFormItems( 40));
       // vdd($this->allCompanies());
       // vdd($this->product());
        //vdd($this->productOffers(38));
        //vdd($this->productItemByCatalogId(18));
       /// vdd($this->singleProductItemByOptions(19,41, ));
       //vdd($this-> productItemByElementId(1817));
       vdd($this->getPropertsByCategory2(125));
    }
...
#region productItem and database
    ...
    public function product($shop_product_id = null, $company_id = null)
    {
        ...
        $properties = [];
        $shop_product->shop_option_ids = json_decode($shop_product->shop_option_ids);
    ...
    public function productItemByElementId($element_id, $user_company_id = null)
    {
        ...
        if (\Dash\count($shop_element->shop_option_ids))
          $shop_element->shop_option_ids = json_decode($shop_element->shop_option_ids);
             #check
