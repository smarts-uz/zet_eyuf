...
class Adder_U extends ZFrame
{
    ...
    public const path = [
        'nginxPath' => 'D:/Develop/Projects/asrorz/zetsoft/hoster',
        'sampleVhosts' => 'D:/Develop/Projects/asrorz/zetsoft/hoster/sample/vhosts.conf',
        'extractPath' => 'D:/Develop/Projects/backup/extract',
        'profilePath' => 'D:/Develop/Projects/asrorz/zetsoft/hoster/profile/Profiles',
        'testRootDir' => 'D:/Develop/Projects/asrorz/zettest',
        'recyclePath' => 'D:/Develop/Projects/history/recycle/',
    ];
...
//    }
    ...
    public function appClone(){
        ...
        $this->nginxConf();
        Az::debug('Add domain nameOn to host...');
        $this->updateHosts();
    ...
    public function createSql($path = Root . '/render/sql/test.sql'){
        ...
        $proc->run($cmd,
            ...
            function ($output, $pid){
                vd('Error on creating sql file |' . $pid);
            },);
    ...
    public function updateNgnix($revert = false)
    {
        ...
        if ($this->domain) {
            ...
            $replace = [
                '{domain}' => "$this->domain",
                '{app}' => $this->domain,
                '{root}' => "d:/Develop/Projects/backup/zetsoft/",
            ];
        ...
        foreach ($history_sub_dirs as $dir) {
            ...
            $replace = [
                ...
                '{app}' => $this->newName,
                '{root}' => "d:/Develop/Projects/history/$innerFolder/zetsoft/",
            ];
            $content = strtr($content, $replace);
        ...
        foreach ($folders as $folder) {
            ...
            $replace = [
                ...
                '{app}' => $this->newName,
                '{root}' => $folder === 'backup' ? "d:/Develop/Projects/backup/zetsoft/" : "d:/Develop/Projects/asrorz/zetsoft/",
            ];
            $content = strtr($content, $replace);
...
//            $item->sourceDir = $temp_path;
    ...
    public function restartNginx(){
        ...
        chdir('D://Develop/Projects/server/nginx/');
...
//            $t = 1;
    ...
    public function extract()
    {
        ...
        $app_destination = self::path['extractPath'] . '/1';
        /*       if (!file_exists($app_destination))
                   $boot->mklink($app_destination);*/

        /**
         * actions
         */

        $actions_dir = "D:/NewTest";
        //vdd($app_destination . "/actions");
//        symlink($actions_dir, $app_destination );
       $boot->makelink($actions_dir, $app_destination );
    }
...
//        $this->testRemoveToRecycle($app);
    ...
    {
      /*  $process = new Process(['d:/Develop/Projects/server/nginx/nginx -t']);
        $process->run(function ($type, $buffer) {
            if (Process::ERR === $type) {
                echo 'ERR > '.$buffer;
            } else {
//
                chdir('d:\Develop\Projects\server\nginx\\');
        ...
        Az::$app->utility->execs->exec("net start Zetsoft_Nginx");*/
        chdir('d:\Develop\Projects\server\nginx\\');
        Az::$app->utility->execs->chdir('d:\\Develop\\Projects\\server\\nginx\\');
