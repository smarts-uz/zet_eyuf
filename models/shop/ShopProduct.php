    ...
    */
    ...
    public function event()
    {
        ...
        $event->afterSave = function (ShopProduct $model) {
            ...
            /** @var \zetsoft\models\shop\ShopElement[] $elements */
            $elements = $this->getShopElementsWithShopProductIdMany();
            
            foreach ($elements as $element ) {
                $element->shop_category_id = $this->shop_category_id;
                $element->save();
            }
            

           // $category = $this->getShopCategoryOne();
