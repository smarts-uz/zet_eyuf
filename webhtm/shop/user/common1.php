...
$products = Az::$app->market->product->allProducts($categoryId ?? null);
?>
        ...
        <div class="col-3">
            <div class="row mx-1">
                ...
                <div class="col-12">
                    ...
                    $model = Az::$app->smart->widget->getFilter();
                    ...
                    <div class="col-12">
                        <div id="contento" class="row w-100">
                            ...
                            echo ZInfinityScrollAjaxWidget::widget([
                                'config' => [
                                    'url' => '/blocks/infinite/infinite.aspx', 'requireUrl' => '/render/cards/ZListViewWidget/demo/vertical_horizontal.php',
                                    'limit' => 12,
                                    'cols' => 2
                                ]
                            ]);
                ...
                <? else: ?>
                    <div class="mt-5 mx-auto">
                        <div class="text-center">
                            <i class="fas fa-exclamation-circle fa-10x text-light"></i>
                            <h3 class="mt-5 text-muted">
                                <?= Az::l('В данный момент нет товаров в этой категории') ?>
                            </h3>
