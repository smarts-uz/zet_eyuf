...
$review = Az::$app->market->review->getReviewByProductId($product_id);
...
?>
<script>
    if (<?= $product->cart_amount ?> > 0){
        $("#input-<?=$product->id?> input").val(<?= $product->cart_amount ?>);
    }
</script>
            ...
            <div class="pl-5 w-100">
                ...
                <table class="table w-100">
                    ...
                    <tr>
                        ...
                        <td><p class="mt-3"><?= Az::l('Oптом и розница')?></p></td>
                        <td class="text-right">

                            <a class="text-muted fz-12" onclick="add_wish_list(8,$(this),true)">
                                <i class="fa fa-heart fa-2x mt-1 <?= $product->in_wish ? 'text-danger' : '' ?>"></i>
                            </a>
                            <span class="fz-18 text-dark ml-2 my-2">
                                <?= Az::l('Избранное') ?>
                            </span>
                        ...
                        <td class="text-left">
                            <a class="text-muted fz-12" onclick="add_compare_list(8,$(this),false)">
                                <i class="fa fa-chart-bar fa-2x mt-1 <?= $product->in_compare ? 'text-success' : '' ?>"></i>
                            </a>
                            <span class="fz-18 text-dark ml-2 my-2">
                                <?= Az::l('Сравнить') ?>
                            </span>
...
-->
                    <div class="d-block ml-5 text-center  p-2">
                        ...
                        <div class="text-black-50 text-left fz-16 p-1 pl-0"><?=$product->currency?>.<?=Az::l(' за 1 шт')?>.</div>
