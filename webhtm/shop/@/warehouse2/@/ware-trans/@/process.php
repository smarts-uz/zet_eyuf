    ...
    <div id="content" class="content-footer p-3">
        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                ...
                $ware_trans->configs->nameOff = [
                    'name'
                ];
                $ware_trans->date = Az::$app->cores->date->dateTime();
                $ware_trans->configs->widget = [
                    'date' => ZInputWidget::class
                ];
                $ware_trans->configs->readonlyWidgetAll = true;
