...
$action->title = Azl . 'Редактирование Бренды';
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                $model->configs->widget = [
                    'name' => ZHHiddenInputWidget::class
                ];
                
                $model->columns();
                
                if ($this->modelSave($model)) {
                    $model->redirect_url = $model->url . '?statId=';
                    $model->created_url = $this->urlGetBase() . '/cpatrack/redirect.aspx?trackId=' . $model->id;
                    $model->save();
