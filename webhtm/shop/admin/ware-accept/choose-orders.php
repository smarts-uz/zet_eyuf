...
<div class="p-3">
    ...
    <div class="p-2 row justify-content-end dynaCheck">
        ...
        $checkUrl = ZUrl::to([
            '/shop/admin/ware-accept/choose-dc',
        ...
        echo ZGetChecksWidget::widget([
            ...
            'event' => [
                'ajaxSuccess' => <<<JS
                     function() {
                         window.top.location.href = "/shop/admin/ware-accept/process.aspx?ware_accept_id=$ware_accept_id"    
                     }
JS,
            ],
            //end
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            ...
            echo ZDynaWidget::widget([
                ...
                'config' => [
                    'viewUrl' => '/shop/admin/ware-accept/view-return.aspx?ware_return_id={id}',
                    'actionButtons' => [
                        'view',
                    ],
                    'columnBefore' => [
