        ...
        <div class="card-body">
            ...
            <div class="row px-lg-2 px-4">
                ...
                <div class="col-md-6 col-xl-8 pl-md-3 px-lg-auto px-0">
                    ...
                    <div style="width: 100%;z-index: 20 ; height: 70px !important;"
                        ...
                        if (!empty($userId)) {
                            ...
                            $userInfo =
                                "<p class='font-bold font-md text-dark ml-4 text-uppercase' >$currName</p>";
                        ...
                        if (!empty($userId)):
                            ...
                            if (empty($menBloklagan)) {
                                echo '<span onclick="block()" class="leftBtn">
                                    <button class="btn btn-danger btn-sm btn-rounded" style="
                                     right: 15px;position: absolute;top:8px;cursor:pointer;height:4%!important; z-index:0; "><i class="fas fa-ban"></i>&nbsp;Блок</button>
                                </span>';
                            } else {
                                echo '<span onclick="unblock()" class="leftBtn"  style=" right: 15px;position: absolute;top:8px;cursor:pointer;">
                                      <button class="btn btn-success btn-sm btn-rounded" style="right: 15px;position: relative;top:8px;cursor:pointer;height:28%!important; z-index:0;" ><i class="fas fa-check"></i>&nbsp;Pазблок</button>
                                </span>';
                            }
                                ...
                                <div class="chat-footer border-top py-4 py-lg-6 px-lg-8">
                                    <div class="container-xxl">
                                        ...
                                        <form id="chat-id-2-form"
                                              action="https://themes.2the.me/Messenger-1.1/assets/php/upload.php"
                                              data-emoji-form="">
                                                ...
                                                <div class="col">
                                                    <div class="input-group">
                                                        ...
                                                        <textarea id="chat-id-2-input"
                                                                  ...
                                                                  style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 46px;"></textarea>

                                                        <!-- Emoji button -->
                                                        <div class="input-group-append">
                                                            <button class="btn btn-sm  btn-primary border-0 rounded-circle "
                                                                    type="button">
                                                                <i class="far fa-smile ii-n"></i>
                                                            </button>
                                                        </div>
                                                        ...
                                                        <div class="input-group-append ">
                                                            <button id="chat-upload-btn-2 "
                                                                    class="btn btn-primary rounded-circle btn-sm border-0 dropzone-button-js"
                                                                    type="button">
                                                        ...
                                                        <div class="input-group-append ">
                                                            <button class="btn btn-sm btn-ico btn-primary rounded-circle "
                                                                    type="submit">
                                                                <i class="far fa-paper-plane ii-n"></i>
                                                            </button>
                                                        </div>
