...
<head>
    ...
    $this->fileCss('https://cdn.jsdelivr.net/npm/open-iconic@1.1.1/font/css/open-iconic-bootstrap.css');
    $this->fileCss('https://cdn.jsdelivr.net/npm/animate.css@4.1.0/animate.min.css');
    $this->fileCss('https://cdn.jsdelivr.net/npm/owl.carousel@2.3.4/dist/assets/owl.carousel.min.css');
    $this->fileCss('https://cdn.jsdelivr.net/npm/owl.carousel@2.3.4/dist/assets/owl.theme.default.min.css');
    $this->fileCss('https://cdn.jsdelivr.net/npm/magnific-popup@1.1.0/dist/magnific-popup.css');
    $this->fileCss('https://cdn.jsdelivr.net/npm/aos@2.3.4/dist/aos.css');
    $this->fileCss('https://cdn.jsdelivr.net/npm/ionicons@4.5.0-0/dist/css/ionicons.min.css');
    $this->fileCss('/render/grapeAssets/digilab/css/icomoon.css');
    $this->fileCss('/render/grapeAssets/digilab/css/style.css');
    $this->fileJs('https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false');
    $this->fileJs('/render/grapeAssets/digilab/js/main.js');
    $this->fileJs('https://cdn.jsdelivr.net/npm/jquery-migrate@3.3.1/dist/jquery-migrate.min.js');
    $this->fileJs('https://cdn.jsdelivr.net/npm/jquery.stellar@0.6.2/jquery.stellar.js');
    $this->fileJs('https://cdn.jsdelivr.net/npm/jquery-waypoints@2.0.5/waypoints.js');
    $this->fileJs('https://cdn.jsdelivr.net/npm/magnific-popup@1.1.0/dist/jquery.magnific-popup.min.js');
    $this->fileJs('https://cdn.jsdelivr.net/npm/jquery.easing@1.3.0/jquery.easing.1.3.min.js');
    $this->fileJs('https://cdn.jsdelivr.net/npm/popper.js@1.16.1/dist/umd/popper.min.js');
    $this->fileJs('https://cdn.jsdelivr.net/npm/scrollax@1.0.0/scrollax.min.js');
    $this->fileJs('https://cdn.jsdelivr.net/npm/owl.carousel@2.3.4/dist/owl.carousel.min.js');
    $this->fileJs('https://cdn.jsdelivr.net/npm/aos@2.3.4/dist/aos.min.js');
    $this->fileJs('https://cdn.jsdelivr.net/npm/jquery.animate-number@0.0.14/jquery.animateNumber.min.js');
    $this->fileJs('/render/grapeAssets/digilab/js/google-map.js')
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300" class="<?= ZWidget::skin['white-skin']  ?>">
...
<section class="ftco-section-2 img" style="background-image: url(/assets/images/bg_3.jpg);">
    <div class="container">
