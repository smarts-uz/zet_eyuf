      ...
      foreach ($items as $item)
      {
          ...
          $button = ZButtonWidget::widget([
              ...
              'config' => [
                //  'btnRounded' => false,
                  'text' => Az::l('Ответить'),
                  'url' => Zurl::to(['/shop/user/company/review-reply','id' => $item->id, 'type' => $item->type]),
...
$result= '<p>'.Az::l('Для данного магазина еще не задали вопрос, но вы можете быть первыми!').'</p>';
if(!empty($items))
