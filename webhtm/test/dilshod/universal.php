...
<div id="page">
    ...
    echo ZSessionGrowlWidget::widget();Az::$app->cores->chess->id = 2;
    Az::$app->cores->chess->init();
    $model = Az::$app->cores->chess->createModel();
    $data = Az::$app->cores->chess->generateData();
