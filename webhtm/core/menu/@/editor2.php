...
<div class="pr-2 pl-2">
    <div class="row">
        <div class="col-md-6 section-1">
            ...
            <button id="btnOutput" class="btn-1 btn" style="display: none;"></button>
                        ...
                        <div class="form-group section-6">
                            ...
                            <div class="d-flex align-items-center w-100">
                                ...
                                <div class="d-flex align-items-center w-25 ml-4">
                                    ...
                                    <i class="fas fa-cubes iconn" style="font-size: 30px; margin-right: 10px"></i>
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex align-items-center w-100">
                                ...
                                <div class="d-flex align-items-center w-25 ml-4">
                                    ...
                                    <span class="iconn"><i id="ico" class="fab fa-font-awesome iconn" style="font-size: 30px;margin-right: 10px"></i></span>
                    ...
                    <div class="form-group d-flex ml-2">
                        ...
                        <div class="input-group">
                            ...
                            <div class="d-flex w-100">
                                <div>
                                    <i class="fas fa-bullseye iconn" style="font-size: 40px; margin-right: 5px;margin-left: 1px"></i>
                                </div>
                                ...
                                <div class="d-flex w-25" style="margin-left: 28px">
                                    <?php
...
JS,
                    ...
                    <div class="form-group d-flex ml-1 section-3 align-items-center justify-content-start w-100">
                        ...
                        <div>
                            <i class="fab fa-css3-alt icon_css" style="font-size: 40px; margin-right: 15px; margin-left: 10px;"></i>
                        </div>
                    ...
                    <div class=" d-flex ml-2 align-items-center w-100">
                        <div>
                            <i class="fas fa-eye iconn" style="font-size: 35px; margin-right: 9px;margin-left: 3px"></i>
                        </div>
                        <div class="w-100">
                            <?
                            echo ZSelect2Widget::widget([
