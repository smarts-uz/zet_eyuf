...
<div id="page">
    ...
    <div class="row p-3">
        ...
        function() {
          ...
          $.ajax({
            url:'/api/core/dyna/cancel.aspx', 
            data:{
                sessionKey : '{$sessionKey}',
                isNew : false,
                modelId : {$order->id},
                modelName: '{$order->className}',
            },
            success: function(){
                location.reload()
            }
...
JS,
            ...
            $button = ZButtonWidget::widget([
                'config' => [
                    ...
                    'url' => ZUrl::to([
                        '/core/help/order-toshkent/indexToshkent'
                    ]),
...
JS,
            ...
            if ($this->modelSave($order)) {
                $this->urlRedirect(['indexToshkent', true]);
            }
