...
$products = Az::$app->market->product->allElements(null, null, 0, 12);
    ...
    <div class="col-xl-9 col-lg-8">
      ...
      if (isset($category_id))
        echo ZBreadcrumbsWidget::widget([
            'config' => [
                'mainUrl' => '/shop/user/filter-common',
      ...
      <h4 class="py-3">КАК СДЕЛАТЬ ЗАКАЗ?</h4>
      <?php
...
<div class="container-fluid mt-2 mb-5">
  ...
  <div class="row mt-4">
    ...
    <div class="col-12 ml-2">
      <h3 id="popular"><?= Az::l('Популярные')?><span class="ml-4 badge badge-danger shadow-none fe-05"></span></h3>
    </div>
  ...
  <div class="row mt-4">
    <div class="col-12 ml-2 ">
      <h3 id="new" >Новинки<span class="ml-2 badge badge-success shadow-none fe-05">New</span></h3>
    </div>
    <div class="col-12">
      <div class="row">
        <?
  ...
  <div class="row">
    <div class="col-12 mt-4">
      <h3 id="discount" >Cкидки<span class="ml-4 badge badge-danger shadow-none fe-05"><i
...
<?php
require Root . '/render/market/ZPriceWidget/ready/clean.php';
?>
